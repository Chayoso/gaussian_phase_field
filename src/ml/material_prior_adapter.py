...
SENTENCE_STYLE_RULES = (
    {
        ...
        "runtime": {
            ...
            "manifold.hoop_weight": 0.0,
            "manifold.ring_weight": 0.0,
            "manifold.overlap_exclusion_weight": 0.0,
    ...
    },
    {
        ...
        "runtime": {
            ...
            "manifold.hoop_weight": 0.46,
            "manifold.ring_weight": 0.48,
            "manifold.overlap_exclusion_weight": 0.14,
            "manifold.fragment_detect_active_every": 4,
    ...
    },
    {
        ...
        "runtime": {
            ...
            "manifold.hoop_weight": 0.38,
            "manifold.ring_weight": 0.34,
            "manifold.overlap_exclusion_weight": 0.22,
            "manifold.fragment_detect_active_every": 4,
    ...
    },
    {
        ...
        "runtime": {
            ...
            "manifold.hoop_weight": 0.12,
            "manifold.ring_weight": 0.10,
            "manifold.overlap_exclusion_weight": 0.18,
            "manifold.fragment_detect_active_every": 3,
    ...
    },
    {
        ...
        "runtime": {
            ...
            "manifold.hoop_weight": 0.0,
            "manifold.ring_weight": 0.0,
            "manifold.overlap_exclusion_weight": 0.42,
...
FAMILY_RUNTIME_PRESETS = {
    "sharp_brittle": {
        ...
        "manifold.hoop_weight": 0.10,
        "manifold.ring_weight": 0.08,
        "manifold.overlap_exclusion_weight": 0.14,
    ...
    "brittle_moderate": {
        ...
        "manifold.hoop_weight": 0.08,
        "manifold.ring_weight": 0.05,
        "manifold.overlap_exclusion_weight": 0.18,
    ...
    "rough_quasi_brittle": {
        ...
        "manifold.hoop_weight": 0.06,
        "manifold.ring_weight": 0.04,
        "manifold.overlap_exclusion_weight": 0.10,
        "manifold.fragment_detect_every": 2,
    ...
    "neutral_reference": {
        ...
        "manifold.hoop_weight": 0.06,
        "manifold.ring_weight": 0.04,
        "manifold.overlap_exclusion_weight": 0.12,
        "manifold.fragment_detect_every": 2,
