...
def make_crack_front(fracture_params, device):
    return CrackFront(
        ...
        hoop_weight=fracture_params.get('hoop_weight', 0.0),
        ring_weight=fracture_params.get('ring_weight', 0.0),
        lift_weight=fracture_params.get('lift_weight', 0.40),
        overlap_exclusion_weight=fracture_params.get('overlap_exclusion_weight', 0.0),
